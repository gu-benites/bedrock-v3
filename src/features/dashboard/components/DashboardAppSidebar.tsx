...
export function DashboardAppSidebar({ className, ...props }: Omit<React.ComponentProps<typeof Sidebar>, 'variant' | 'collapsible'>) {
    ...
    <Sidebar className={className} {...props}>
      ...
      <SidebarFooter>
        <DashboardUserMenu
          ...
          onRequestSidebarExpand={() => setOpen(true)}
          // notificationCount can be passed if available, e.g., from a global state or props
        />
      </SidebarFooter>
    </Sidebar>
  )
