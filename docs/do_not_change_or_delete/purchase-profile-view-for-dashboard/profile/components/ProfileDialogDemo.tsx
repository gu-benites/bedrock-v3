...
const ProfileBg: React.FC<ProfileBgProps> = ({ defaultImage }) => {
  ...
  return (
    <div className="h-32">
      <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-muted">
        ...
        {/* Buttons container matches original demo.tsx structure */}
...
const Avatar: React.FC<AvatarProps> = ({ defaultImage }) => {
  ...
  return (
    <div className="-mt-10 px-6">
      <div className="relative flex size-20 items-center justify-center overflow-hidden rounded-full border-4 border-background bg-muted shadow-sm shadow-black/10">
        ...
        {/* Button styling matches original demo.tsx */}
        <button
          type="button"
...
export const ProfileDialogDemo: React.FC = () => {
  const id = useId();
  const maxLength = 180;
  const {
    value: bioValue,
    ...
    <Dialog>
      ...
      <DialogContent className="flex flex-col gap-0 overflow-y-visible p-0 sm:max-w-lg [&>button:last-child]:top-3.5">
        <DialogHeader className="contents space-y-0 text-left">
          {/* Reverted title text, text-base overrides default text-lg from component */}
        ...
        {/* Removed max-h constraint to match original demo.tsx */}
        <div className="overflow-y-auto"> 
          <ProfileBg defaultImage="https://picsum.photos/seed/profbg1/512/96" />
          <Avatar defaultImage="https://picsum.photos/seed/avatar1/80/80" />
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <div className="pointer-events-none absolute inset-y-0 end-0 flex items-center justify-center pe-3 text-muted-foreground/80 peer-disabled:opacity-50">
                    <Check
                      size={16}
                      strokeWidth={2} // Reverted strokeWidth
              ...
              <div className="space-y-2">
                ...
                <div className="flex rounded-lg shadow-sm shadow-black/5">
                  {/* Reverted span classes to match original demo.tsx */}
                  ...
                  {/* Reverted Input classes to match original demo.tsx */}
                  <Input
                    id={`${id}-website`}
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  value={bioValue} // Using value for controlled component as per useCharacterLimit
                  maxLength={maxLength}
                  onChange={handleBioChange}
                  aria-describedby={`${id}-description`}
                  // Removed rows={3} to match original demo.tsx
                />
                <p
                  id={`${id}-description`}
